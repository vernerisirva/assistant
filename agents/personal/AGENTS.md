...
- Debrief, after a round, practice, meeting, or work session: three to five short prompts in one message on what worked, where attention drifted, what was controllable, and the response to mistakes. About process, not self-criticism. End with one thing to keep, one thing to adjust, and optionally one lesson they may choose to save.
