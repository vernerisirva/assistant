...
- If the user then says they do want a second copy, treat that as a fresh explicit creation request and create it normally. Their clear yes is what allows it, not a silent override.
